...
function List({coin}) {
  return (
    <tr className="list-row">
      <Tooltip title="Logo" placement="bottom-center">
        <td className="td-imgae">
          <img src={coin.image} className="coin-logo" />
        </td>
      </Tooltip>
      <Tooltip title="Symbol" placement="bottom-center">
        <td>
      ...
      <Tooltip title="Price change 24Hrs" placement="bottom-center">
      ...
      <Tooltip title="Total Volume" placement="bottom-center">
        <td>
          <p className="total_value">${coin.total_volume.toLocaleString()}</p>
        </td>
      </Tooltip>
      <Tooltip title="Market Cap" placement="bottom-center">
        <td>
